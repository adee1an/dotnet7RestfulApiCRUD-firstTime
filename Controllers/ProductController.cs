...
public class ProductController : ControllerBase
{
    ...
    {
        return Ok(new { productId = id, name = "nanas", cat = category, user = user });
    }
